            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6">
                <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
                    ...
                    <p className="text-xs text-gray-600 font-inter text-center">
                        © {new Date().getFullYear()} PS Racing Game. All rights reserved.
                    </p>
                    ...
                    <div className="flex items-center gap-3">
                        <a
                            ...
                            aria-label="WhatsApp"
                        >
                            <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor" className="text-gray-500 group-hover:text-green-400 transition-colors">
